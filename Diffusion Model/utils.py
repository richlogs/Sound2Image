...
def get_data(args):
    ...
    train_dataset = CustomDataset(os.path.join(args.dataset_path, args.train_folder), name_path=args.name_path,
     embedding_path=args.embedding_path, image_size=args.img_size,transform=train_transforms)
    val_dataset = CustomDataset(image_path=os.path.join(args.dataset_path, args.val_folder), name_path=args.name_path,
     embedding_path=args.embedding_path, image_size=args.img_size,transform=val_transforms)
